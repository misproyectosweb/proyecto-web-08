        ...
        <main>
            ...
            <div class="container-fluid d-flex flex-row justify-content-center px-0">                                
                <div class="row col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 justify-content-center">
                    <h1 class="titulo text-black-50 my-4 display-4 font-weight-bold">Nuestros servicios</h1>
            ...
            <div class="container-fluid">        
                <div class="row justify-content-center">
                    <div class="col-11 col-sm-11 col-md-11 col-lg-6 col-xl-6 d-flex align-items-center">
                        <img src="imagenes/imgServicios_1.jpg" class="img-fluid mx-auto d-block rounded-lg">
                    </div>
                    <div class="col-11 col-sm-11 col-md-11 col-lg-6 col-xl-6">
                        <div>
                            <h3 class="pb-2 text-center text-black-50">Praesent a mauris ut tortor</h3>                        
                ...
                <div class="row justify-content-center border-dark-50 border-top"> 
                    <div class="col-11 col-sm-11 col-md-11 col-lg-6 col-xl-6 d-flex align-items-center">
                        <img src="imagenes/imgServicios_2.jpg" class="img-fluid mx-auto d-block rounded-lg">
                    </div>                                        
                    <div class="col-11 col-sm-11 col-md-11 col-lg-6 col-xl-6">
                        <div>
                            <h3 class="pb-2 text-center text-black-50">Proin pulvinar, lacus eu condimentum convallis</h3>                        
                ...
                <div class="row justify-content-center border-dark-50 border-top">     
                    <div class="col-11 col-sm-11 col-md-11 col-lg-6 col-xl-6 d-flex align-items-center">
                        <img src="imagenes/imgServicios_3.jpg" class="img-fluid mx-auto d-block rounded-lg">
                    </div>           
                    <div class="col-11 col-sm-11 col-md-11 col-lg-6 col-xl-6">
                        <div>
                            <h3 class="pb-2 text-center text-black-50">Nulla dictum erat id nisi sagittis malesuada</h3>                        
                ...
                <div class="row justify-content-center border-dark-50 border-top">   
                    <div class="col-11 col-sm-11 col-md-11 col-lg-6 col-xl-6 d-flex align-items-center">
                        <img src="imagenes/imgServicios_4.jpg" class="img-fluid mx-auto d-block rounded-lg">
                    </div> 
                    <div class="col-11 col-sm-11 col-md-11 col-lg-6 col-xl-6">
                        <div>
                            <h3 class="pb-2 text-center text-black-50">Interdum eleifend nunc, in auctor mi interdum ac</h3>                        
                ...
                <div class="row justify-content-center border-dark-50 border-top">  
                    <div class="col-11 col-sm-11 col-md-11 col-lg-6 col-xl-6 d-flex align-items-center">
                        <img src="imagenes/imgServicios_5.jpg" class="img-fluid mx-auto d-block rounded-lg">
                    </div>                                              
                    <div class="col-11 col-sm-11 col-md-11 col-lg-6 col-xl-6">
                        <div>
                            <h3 class="pb-2 text-center text-black-50">Cras enim tellus, iaculis sit amet iaculis imperdiet</h3>                        
                ...
                <div class="row justify-content-center border-dark-50 border-top">   
                    <div class="col-11 col-sm-11 col-md-11 col-lg-6 col-xl-6 d-flex align-items-center">
                        <img src="imagenes/imgServicios_6.jpg" class="img-fluid mx-auto d-block rounded-lg">
                    </div>  
                    <div class="col-11 col-sm-11 col-md-11 col-lg-6 col-xl-6">
                        <div>
                            <h3 class="pb-2 text-center text-black-50">Quisque ac dictum augue. Integer non tempus felis</h3>                        
                ...
                <div class="row p-5">
                    ...
                    <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <a href="#" class="list-group-item text-white text-decoration-none bg-secondary border-0 py-1 px-0"><i class="bi bi-envelope-fill text-white mr-3"></i>lorem_ipsum@tallerenterprice.com</a>                            
                        </div>
                    </div>
                </div>
            </div>
